...
with open('/Users/xuegeng/Desktop/crawler/shop_comment_pages5.json','r') as f:
...
def change_page_crawled(fpath):
    ...
    if not origin_is_page_crawled[url] and os.path.exists(fpath):
...
with open('/Users/xuegeng/Desktop/crawler/shop_comment_pages_crawled6.json','w') as f:
